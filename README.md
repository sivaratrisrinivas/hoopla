...
|---|---|---|---|---|
| BM25 | 0.3800 | 0.5157 | 0.3607 | 3418.9 |
| Semantic | 0.3200 | 0.4606 | 0.3088 | 325.9 |
| RRF | 0.3800 | 0.5049 | 0.3599 | 3773.5 |
| RRF + cross-encoder | 0.3600 | 0.4824 | 0.3357 | 3959.3 |

Index build time: 349.72s (BM25 16.26s, chunk embeddings 333.46s, cold rebuild). The eval always rebuilds the HybridSearch index it scores, so a cache hit cannot rewrite this number to ~0.
